...
nvidia-settings -a [gpu:2]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:3]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:4]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:5]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:6]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:7]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:8]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:9]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:10]/GpuPowerMizerMode=2
...
nvidia-settings -a [gpu:11]/GpuPowerMizerMode=2
